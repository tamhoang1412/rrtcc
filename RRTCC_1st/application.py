...
class application:
    def __init__(self, address):
        ...
        #for RRTCC
        #self.packets_info = [[0, 0, self.RTP_interval*(i+10)] for i in range(0, self.RTP_packets_num)]
    ...
    def get_sq_num_vector_and_base_transport_sq_num(self):
        ...
        for i in range (self.last_pk_reported + 1, self.last_received_RTP):
            if self.received_pk_list[i][1] >= (self.last_RTCP_sent_time):
                print 'get vector ' + str(self.received_pk_list[i][1]) + ' ' + str(self.last_RTCP_sent_time)
        ...
        print 'get sq' + str(base_transport_sq_num) + str(sq_num_vector)
    ...
    def adjust_RTP_sending_rate(self, env, RTCP_packet):        
        ...
        print 'adjust As:' + str(As) + ' Ar:' + str(Ar)
    ...
    def delaybased_control_estimated_bandwidth(self, env, rtcp_timestamp):
        ...
        if self.state == 'I':
            ...
            if increase_state == "multiplicative":
                ...
                print "packets_per_frame " + str(packets_per_frame)
