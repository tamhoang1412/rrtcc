...
class GccController:
    ...
    def adjust_RTP_sending_rate(self, env, RTCP_packet, last_received_RTP, RTCP_limit, RTP_packet_size, RTP_interval, last_sent_RTP):
        ...
        Ar = self.db_controller.estimate_bandwidth(env, RTCP_packet.timestamp, self.packets_info, self.m, self.del_var_th, last_received_RTP, RTCP_limit, RTP_packet_size)
