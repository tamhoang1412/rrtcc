# -*- coding: utf-8 -*-
"""
Created on Sat Oct 08 18:56:03 2016
...
class Event:
    def __init__(self, source, destination, occurredTime):
        self.source = source
        self.destination = destination
...
HostA = Host("HostA", "log1.txt")
HostB = Host("HostB", "log2.txt")
Network = Network("Network", "log3.txt")
